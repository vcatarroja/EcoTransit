...
def directions(origin, destination,
    ...
    url = f"https://maps.googleapis.com/maps/api/directions/json?origin={origin}&destination={destination}&key=AIzaSyADfbzebwGYDUY8ADb8sRZRe8I14uIU4QY"
...
origin = "15000 Arroyo Dr"
destination = "Irvine Barclay Center"

test = directions(origin,destination)
print(test)
